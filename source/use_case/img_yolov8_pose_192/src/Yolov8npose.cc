...
const tflite::MicroOpResolver& arm::app::Yolov8npose::GetOpResolver()
{
    return this->m_opResolver;
}

bool arm::app::Yolov8npose::EnlistOperations()
{
...
const uint8_t* arm::app::Yolov8npose::ModelPointer()
{
    return GetModelPointer();
}

extern size_t GetModelLen();
size_t arm::app::Yolov8npose::ModelSize()
{
    return GetModelLen();
}